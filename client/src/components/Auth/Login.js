    ...
    >
      <div className="w-full max-w-md">
        ...
        >
          ...
          {/* Divider and Social Login - Hidden until OAuth is configured */}
          {/* To enable: Set up Google/Facebook OAuth credentials in your .env file */}
          {false && (
            <>
              {/* Divider */}
            ...
            <div className="space-y-3">
              <button 
                ...
                className="w-full bg-white bg-opacity-10 hover:bg-opacity-20 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 flex items-center justify-center space-x-2"
              >
